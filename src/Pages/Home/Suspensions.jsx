import { Article, DisplayTwo, Lead, Icon } from "../../components/Styled/Styled";
...
export default function Suspensions() {
    return (
        <div>
            <Article>
                <Icon border="#F87171" start="#475569" end="#DC2626" fill="#FCA5A5">
                ...
                <DisplayTwo align="center">Suspensiones</DisplayTwo>
                ...
                <CardPicture width="60%">
                    <img loading="lazy" src={suspension} alt="" style={{ width: '100%' }}/>
                </CardPicture>
            </Article>
        </div>
    )
