...
import video from '../../assets/video/sacc-enterprice.mp4';
...
export default function GeneralVideo() {
    return (
        <div>
            <Article>
                <Icon border="#3B82F6" start="#1D4ED8" end="#60A5FA" fill="#93C5FD">
                ...
                <DisplayTwo align="center">Tome el control de su negocio</DisplayTwo>
                <Lead width="50%" align="center">
                    A continuación le mostramos una visión general de lo que puede hacer con el sistema.
                </Lead>
                <CardPicture width="60%">
                    <Video poster={dashboard} src={video} controls />
                </CardPicture>
            </Article>
        </div>
    )
